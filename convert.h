...
namespace airnav::uat {
	/*! \brief Describes a sample data layout */
	enum class SampleFormat {
		...
		UNKNOWN		/*!< unknown sample data format */
	};

	/**
	 * \brief Return the number of bytes for 1 sample in the given format
	 *
	 * \param f  Sample format
	...
	public:
		...
		SampleConverter(SampleFormat format): format_(format),
			bytes_per_sample_(airnav::uat::BytesPerSample(format)) {
		}
